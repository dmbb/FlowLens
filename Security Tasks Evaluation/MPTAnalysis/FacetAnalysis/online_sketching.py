        ...
        for binWidth in BIN_WIDTH:
            for topk in TOPK:
                ...
                for n, row in enumerate(reader):
                    if(n == 0):
                        output.write(",".join(str(x) for x in n_bits) + "\n")
                    else:
                ...
                #Facet Traffic
                print "Online_Sketch: Phase 1, Facet - " + feature_set + "/Online_facetTraffic_phase1_" + str(sketch_size) + "_dataset.csv"
                output = open(data_folder + "Online_facetTraffic_phase1_" + str(sketch_size) + "_dataset.csv", "w") 
                ...
                #Facet Traffic
                print "Online_Sketch: Phase 2, Facet - " + feature_set + "/Online_facetTraffic_phase2_" + str(sketch_size) + "_dataset.csv"
                output = open(data_folder + "Online_facetTraffic_phase2_" + str(sketch_size) + "_dataset.csv", "w") 
