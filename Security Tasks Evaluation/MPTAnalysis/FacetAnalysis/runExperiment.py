...
def Experiment(BIN_WIDTH, TOPK, DELTAS, MEMORY_FACTORS, DATASET_SPLIT, COVERT_FLOWS_PERC, N_FLOWS, ONLINE_SKETCH_SIZE, SIGMA_PARAM, NUMBER_OF_PACKETS, COMPRESSIVE_RATIO):
    ...
    """
    #Quantization + Truncation without sketches
    ClassifyTestDataBasedOnModel("normal", BIN_WIDTH, TOPK, N_FLOWS)

    #Generate figures
    GenerateFigures(BIN_WIDTH, TOPK, DELTAS, MEMORY_FACTORS, N_FLOWS)
